    ...
    constructor() {
        ...
        this.translations = {
            'es': {
                ...
                "modal.dashboard.stats": "Estadísticas",
                "modal.dashboard.models": "Modelos",
                ...
                "modal.dashboard.messagesTotal": "Mensajes totales",
                "modal.dashboard.conversations": "Conversaciones",
                "modal.dashboard.tokensEstimated": "Tokens estimados",
                "modal.dashboard.avgTime": "Tiempo promedio respuesta",
                "modal.dashboard.detailedUsage": "📈 Uso detallado",
                "modal.dashboard.detailedStats": "📈 Uso detallado",
                "modal.dashboard.userMessages": "Mensajes enviados (usuario)",
                "modal.dashboard.assistantMessages": "Respuestas recibidas (IA)",
                "modal.dashboard.sentMessages": "Mensajes enviados (usuario)",
                "modal.dashboard.receivedMessages": "Respuestas recibidas (IA)",
                "modal.dashboard.charsSent": "Caracteres enviados",
                "modal.dashboard.charsReceived": "Caracteres recibidos",
                "modal.dashboard.sentChars": "Caracteres enviados",
                "modal.dashboard.receivedChars": "Caracteres recibidos",
                "modal.dashboard.filesAttached": "Archivos adjuntados",
                "modal.dashboard.attachedFiles": "Archivos adjuntados",
                "modal.dashboard.projectsCreated": "Proyectos creados",
                "modal.dashboard.createdProjects": "Proyectos creados",
                "modal.dashboard.recentActivity": "📅 Actividad reciente (últimos 7 días)",
                "modal.dashboard.recentActivityTitle": "📅 Actividad reciente (últimos 7 días)",
                "modal.dashboard.topModels": "🏆 Modelos más usados",
                "modal.dashboard.topModelsTitle": "🏆 Modelos más usados",
                "modal.dashboard.loadingModels": "Cargando información de modelos...",
                "modal.dashboard.loadingModelsText": "Cargando información de modelos...",
                "modal.close": "Cerrar",
                ...
                "modal.memory.addMemory": "Añadir recuerdo",
                ...
                "modal.apiKeys.title": "🔑 API Keys",
                "modal.apiKeys.serperLabel": "Serper API Key",
                "modal.apiKeys.serperHint": "Para búsquedas en la web.",
                "modal.apiKeys.serperLink": "Obtener API Key",
                "modal.apiKeys.serperPlaceholder": "Introduce tu Serper API Key",
                "modal.apiKeys.gnewsLabel": "GNews API Key",
                "modal.apiKeys.gnewsHint": "Para el panel de noticias.",
                "modal.apiKeys.gnewsPlaceholder": "Introduce tu GNews API Key",
                "modal.apiKeys.mapboxLabel": "Mapbox API Key",
                "modal.apiKeys.mapboxHint": "Para el modo viajes y mapas.",
                "modal.apiKeys.mapboxPlaceholder": "Introduce tu Mapbox API Key",
                "modal.apiKeys.toggleVisibility": "Mostrar/ocultar",
                "modal.apiKeys.note": "Nota:",
                "modal.apiKeys.noteText": "Las API keys se guardan de forma segura en el almacenamiento local de tu navegador.",
                "modal.aiPersonalization.chatModesVisible": "Modos de chat visibles",
                "modal.aiPersonalization.chatModesHint": "Elige qué modos mostrar en la barra de entrada",
                "modal.aiPersonalization.virtualPet": "Mascota Virtual",
                "modal.aiPersonalization.showCat": "Mostrar Gatito",
                "modal.background.autoChange": "Cambio automático diario",
                "modal.background.autoChangeDesc": "El fondo cambiará automáticamente cada día a las 00:00",
                "modal.background.selectManually": "Seleccionar fondo manualmente",
